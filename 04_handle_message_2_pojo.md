...
我们与微信服务器的交互主要由两个地方，一个是[接收消息](http://mp.weixin.qq.com/wiki/10/79502792eef98d6e0c6e1739da387346.html)，一个是[回复消息](http://mp.weixin.qq.com/wiki/14/89b871b5466b19b3efa4ada8e577d45e.html)。为了方便操作，我们根据微信官方文档将其抽象为POJO对象，方便我们的开发。

我们把POJO对象分为两类，一类是请求类消息对象，对应我们接收微信服务器的消息。另一类是响应类消息对象，对应我们响应微信服务器的消息。

## 请求类消息对象

我们接收微信服务器的消息一共有7种类型，分别是：
